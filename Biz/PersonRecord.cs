...
namespace com.gxchuwei.BLL
{
	...
	{
		private readonly com.gxchuwei.DAL.PersonRecord dal=new com.gxchuwei.DAL.PersonRecord();
		public PersonRecord()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public com.gxchuwei.Model.PersonRecord GetModelByCache(int ID)
		//{
			
		//	string CacheKey = "PersonRecordModel-" + ID;
		...
		//		catch{}
		//	}
		//	return (com.gxchuwei.Model.PersonRecord)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<com.gxchuwei.Model.PersonRecord> GetModelList(string strWhere)
		{
        ...
        public List<com.gxchuwei.Model.PersonRecord> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				com.gxchuwei.Model.PersonRecord model;
